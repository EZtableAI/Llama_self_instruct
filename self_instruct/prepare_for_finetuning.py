...
def parse_args():
    ...
    parser.add_argument(
        "--instance_files",
        nargs="+",
        default=[r"C:\Users\User\iCloudDrive\實習資料\EZtable\ALpaca\self-instruct\data\gpt3_generations\machine_generated_instances.jsonl"],
        type=str,
    ...
    parser.add_argument(
        ...
        nargs="+",
        default=[r"C:\Users\User\iCloudDrive\實習資料\EZtable\ALpaca\self-instruct\data\gpt3_generations\is_clf_or_not_davinci_template_1.jsonl"],
    )
    parser.add_argument(
        "--output_dir",
        default=r"C:\Users\User\iCloudDrive\實習資料\EZtable\ALpaca\self-instruct\data\gpt3_generations\batch_221203\finetuning/",
        type=str,
    ...
    parser.add_argument(
        ...
        type=str,
        #required=True,
        default=r"C:\Users\User\iCloudDrive\實習資料\EZtable\ALpaca\self-instruct\data\seed_tasks.jsonl",
